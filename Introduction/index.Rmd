...
1. Tricks to produce __html, pdf and docx__ from one source file.

1. Step by step guide to develop an R package that can work integrate Eviews R, and R Markdown.
