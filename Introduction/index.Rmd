...
1. Tricks to produce __html, pdf and docx__ outputs from one source file of __R Markdown__. If you learn R Markdown, you are likely to burn all our Latex ($\LaTeX$) distributions and other authoring (typesetting) applications.
